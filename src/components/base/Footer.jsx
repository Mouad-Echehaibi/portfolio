...
export default function Footer(){
    ...
    return (
        <div className="h-[80vh] flex p-5 flex-col w-full mt-[20vh]">
            <footer ref={footer} className="size-full grid grid-rows-[1fr_2fr_1fr] bg-neutral-950 rounded-3xl">
                ...
                <div className="flexy flex-col! gap-5 w-full  border-t border-dashed border-neutral-800">
                    ...
                    <div className="flexy font-light text-sm text-neutral-300">
                        @copyright 2026 . All right reserved
                    </div>
                    <div className="text-[10px] text-neutral-400 font-thin">Built with React, TailwindCSS, GSAP & Framer Motion.</div>
                </div>
            </footer>
        </div>
    );
